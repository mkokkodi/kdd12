...
public class TestUtils extends Utils {
	...
	private void updateErrorsCV(double actualInstanceQuality, EvalWorker evalWorker,
			String approach, Integer catId, String workerType,
			String currentTask, String model, int fold) {
