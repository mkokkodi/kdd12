...
public class SyntheticRegressionsHier {
	...
	public static void main(String[] args) {
		...
		ODeskTrain.trainingOutPath = "/Users/mkokkodi/Desktop/bigFiles/kdd/synthetic/logits/";
		ru = new RegressionUtils();

		System.out.println("Starting...");
		for (int cat = 9; cat < 10; cat += 2) {
			ODeskTrain.mPlus1 = DataGenerationHierarchy.noOfCatsInClaster+1;//noOfCats inclusters +1 cat + 1;
