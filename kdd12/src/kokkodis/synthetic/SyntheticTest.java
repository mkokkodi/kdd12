...
public class SyntheticTest {
	...
	private static HashMap<String, Double[]> getAllModelCoeffs(String model,
		...
		PrintToFile pf = coeffResults.get(model+cat+ODeskTrain.scoreTh );
		if (pf == null) {
			pf = new PrintToFile();
			coeffResults.put(model, pf);
			pf.openFile(new File(resultPath + model + "//" + "Coeff"+cat+	ODeskTrain.scoreTh +".csv"));
